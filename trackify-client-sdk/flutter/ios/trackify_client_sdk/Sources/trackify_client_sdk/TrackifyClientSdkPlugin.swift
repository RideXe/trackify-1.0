...
public class TrackifyClientSdkPlugin: NSObject, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "trackify_client_sdk", binaryMessenger: registrar.messenger())
    let instance = TrackifyClientSdkPlugin()
