...
/// Tracker configuration. Pass to [TrackifyClientSdk.setConfig] to install or
/// update.
class Config {
  const Config({
...
/// Entry point for the Trackify Client SDK Flutter plugin.
class TrackifyClientSdk {
  static const MethodChannel _channel = MethodChannel('trackify_client_sdk');
  ...
  ///
  /// Pass [alarm] (e.g. `"sos"`) to tag the upload with the Trackify `alarm`
