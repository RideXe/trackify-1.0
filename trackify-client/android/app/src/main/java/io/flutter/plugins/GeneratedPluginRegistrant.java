...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new org.trackify.trackify_client_sdk.TrackifyClientSdkPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin trackify_client_sdk, org.trackify.trackify_client_sdk.TrackifyClientSdkPlugin", e);
    }
  }
}
