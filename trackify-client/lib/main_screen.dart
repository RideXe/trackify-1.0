...
import 'package:trackify_client/main.dart';
import 'package:trackify_client/password_service.dart';
import 'package:trackify_client/preferences.dart';
...
class _MainScreenState extends State<MainScreen> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Trackify Client'),
      ),
