...
import org.trackify.schedule.ScheduleManager;
import org.trackify.storage.DatabaseModule;
import org.trackify.web.WebModule;
...
public final class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length > 0 && args[0].startsWith("--")) {
            WindowsService windowsService = new WindowsService("trackify") {
                @Override
                public void run() {
                    Main.run(configFile);
                }
            ...
            switch (args[0]) {
                case "--install":
                    windowsService.install("trackify", null, null, null, null, configFile);
                    return;
                case "--uninstall":
