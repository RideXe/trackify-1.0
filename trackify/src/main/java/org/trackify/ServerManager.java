/*
 * Copyright 2012 - 2022 Anton Tananaev (anton@trackify.org)
 *
...
import org.trackify.helper.ClassScanner;
...
public class ServerManager implements LifecycleObject {
    ...
    public ServerManager(
        ...
        for (Class<?> protocolClass : ClassScanner.findSubclasses(BaseProtocol.class, "org.trackify.protocol")) {
