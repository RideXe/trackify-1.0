/*
 * Copyright 2025 Anton Tananaev (anton@trackify.org)
 *
...
@Singleton
public class TrackifyCommandSender implements CommandSender {

    private static final Logger LOGGER = LoggerFactory.getLogger(TrackifyCommandSender.class);
    ...
    @Inject
    public TrackifyCommandSender(Config config, Client client) throws IOException {
        this.client = client;
