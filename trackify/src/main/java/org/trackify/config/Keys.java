/*
 * Copyright 2019 - 2025 Anton Tananaev (anton@trackify.org)
 *
...
public final class Keys {
    ...
    public static final ConfigKey<String> SERVER_STATISTICS = new StringConfigKey(
            "server.statistics",
            List.of(KeyType.CONFIG),
            "https://www.trackify.org/analytics/");
    ...
    /**
     * Path to the database driver JAR file. Trackify includes drivers for MySQL, PostgreSQL and H2 databases. If you use
    ...
    /**
     * Database connection URL. By default Trackify uses H2 database.
     */
    ...
    /**
     * LDAP server URL. For more info, check <a href="https://www.trackify.org/ldap/">LDAP config</a>.
     */
    ...
    /**
     * Force OpenID Connect authentication. When enabled, the Trackify login page will be skipped
     ...
     * If this is not provided, Trackify will use the "groups" scope name.
     */
     ...
     * If this is not provided, all OpenID users will have access to Trackify.
    ...
    /**
     * Web interface TCP port number. By default, Trackify uses port 8082. To avoid specifying port in the browser you
     ...
     * For example, it can be Trackify Client push commands.
     */
    ...
    /**
     * Trackify notification API key.
     */
    public static final ConfigKey<String> NOTIFICATOR_TRACKIFY_KEY = new StringConfigKey(
            "notificator.trackify.key",
            List.of(KeyType.CONFIG));
    ...
    /**
     * List of protocols to enable. If not specified, Trackify enables all protocols that have port numbers listed.
     ...
     * specified value (in meters), then Trackify will reuse last known address.
     */
    ...
    /**
     * Map matcher provider type. Currently only "trackify" is supported.
     */
     ...
     * GPS location is not available. Trackify can determine coordinates based on that information using third-party
    ...
    /**
     * If this parameter is set, Trackify will monitor drops in the number of stored messages. If it drops by more
     ...
     * If not provided, Trackify will attempt to get a URL from the server IP address, but it might be a local address.
     */
