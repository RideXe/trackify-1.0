 ...
 */
package org.trackify.mapmatcher;

import jakarta.json.JsonObject;
import jakarta.ws.rs.client.Client;
import jakarta.ws.rs.client.InvocationCallback;

public class TrackifyMapMatcher implements MapMatcher {

    private final Client client;
    private final String url;
    private final String key;

    public TrackifyMapMatcher(Client client, String url, String key) {
        this.client = client;
        this.url = url != null ? url : "https://geocoder.trackify.org/snap";
        this.key = key;
    }
