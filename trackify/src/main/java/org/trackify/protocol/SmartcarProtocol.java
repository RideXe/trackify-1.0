...
public class SmartcarProtocol extends BaseProtocol {

    @Inject
    public SmartcarProtocol(Config config) {
        addServer(new TrackerServer(config, getName(), false) {
            ...
            protected void addProtocolHandlers(PipelineBuilder pipeline, Config config) {
                ...
                pipeline.addLast(new SmartcarProtocolDecoder(SmartcarProtocol.this));
            }
        });
    }
