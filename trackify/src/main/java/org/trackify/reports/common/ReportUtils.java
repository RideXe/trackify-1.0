/*
 * Copyright 2016 - 2025 Anton Tananaev (anton@trackify.org)
 * Copyright 2016 - 2017 Andrey Kunitsyn (andrey@trackify.org)
 *
 ...
 */
package org.trackify.reports.common;
...
import org.trackify.api.security.PermissionsService;
...
import org.trackify.reports.model.BaseReportItem;
import org.trackify.reports.model.StopReportItem;
import org.trackify.reports.model.TripReportItem;
import org.trackify.session.state.MotionProcessor;
import org.trackify.session.state.MotionState;
import org.trackify.session.state.NewMotionProcessor;
import org.trackify.session.state.NewMotionState;
...
import org.trackify.storage.query.Order;
