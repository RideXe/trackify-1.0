/*
 * Copyright 2023 - 2025 Anton Tananaev (anton@trackify.org)
 *
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        if (bytes != null) {
            ...
            if (isHtml || isManifest) {
                ...
                String title = server.getString("title", "Trackify");
                String description = server.getString("description", "Trackify GPS Tracking System");
